...
class Cenario:
    ...
    def __init__(self):
        ...
        "Posicao_carros": []},#(90, 75, 0), (90, 165, 0), (90, 265, 0), (90, 355, 0), (90, 445, 0), (400, 345, -90),                                               (500, 345, -90), (600, 345, -90), (540, 75, 0), (920, 75, 0), (1130, 75, 0)] },


        "Fase_6": 
        {"Imagem_fase": pygame.image.load(diretorio_imagens + "Interacao/Transparencia_menu.png"),
        "Imagem_barreira": [pygame.image.load(diretorio_imagens + "Fases/Borda_fase5.png")],
        "Posicao_barreira": [],
        "Ambientacao": [],
        "Posicao_ambientacao": [],
...
class Carro:
    ...
    def Colidir_carro(self):
        ...
        self.Dano_carro += abs(self.velocidade)
        self.Dano_fase += abs(self.velocidade)
        self.velocidade = 0
    ...
    def draw(self, screen, camera, loop = True):
        ...
        if loop:
            ...
            if self.Vaga.contains(self.rect):
                ...
                self.velocidadex = 0
                self.velocidadey = 0
                self.Finalizar_nivel(screen, camera)
    ...
    def Finalizar_nivel(self, screen, camera):
        ...
        if Numero_fase <= 5:
            ...
            Nivel_finalizado = screen.blit(pygame.image.load(diretorio_imagens + "Interacao/Nivel_finalizado.png"), (300, 170))
    
            Tempo = screen.blit(pygame.image.load(diretorio_imagens + "Interacao/Tempo.png"), (200, 250))
    
            Dano_sofrido = screen.blit(pygame.image.load(diretorio_imagens + "Interacao/Dano_sofrido.png"),(200, 300))
    
            Pontos = screen.blit(pygame.image.load(diretorio_imagens + "Interacao/Pontos.png"),(200, 350))
            ...
            screen.blit(Print_tempo, (330, 250))
            screen.blit(Print_dano, (400, 300))
            screen.blit(Print_pontuacao, (330, 350))
...
#            Print_pontuacao = Fonte.render(str(self.Total_pontos), 1, (115, 115, 115))
#            screen.blit(Print_tempo, (330, 250))
#            screen.blit(Print_dano, (400, 300))
#            screen.blit(Print_pontuacao, (330, 350))
#
